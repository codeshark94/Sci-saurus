...
| # | 질문 | 기본안 |
|---|---|---|
| Q1 | v1 실행 하네스: 독립 Python CLI vs LangGraph vs AutoGen 0.4 | 독립 Python 오케스트레이터(종속 최소) + 부서 실행기 어댑터 |
| Q2 | 최초 타깃 산출물의 언어·포맷 (영어 학술 논문? 한국어 리포트? 템플릿?) | 영어 학술 논문(관행적) + 한국어 요약본 병행 |
