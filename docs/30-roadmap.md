...
This checkout contains the design documents listed in `00-SSOT.md`, a README, the P0 freeze record, the P1 fixture set, a deployment-configuration template, one illustrative search YAML, and the initial `scisaurus` control-plane core (schema/store/events/messages/tasks/documents/changes + CLI) with its fixture-test suite covering T01–T03, T04, T05, T13, and T56–T58. It does not yet contain the scheduler/runner, model adapter, retrieval adapters, review/issue records, a schema validator beyond the test suite, a historical document archive, a functioning multi-agent organization, or measured quality improvement. The scenarios above remain future implementation acceptance requirements.
