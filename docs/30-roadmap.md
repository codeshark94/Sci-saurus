...
This checkout contains the design documents listed in `00-SSOT.md`, a README, and one illustrative search YAML. It does **not** contain the `scisaurus` runtime, a schema/package validator, a historical document archive, a functioning multi-agent organization, or measured quality improvement. The scenarios above are future implementation acceptance requirements.
