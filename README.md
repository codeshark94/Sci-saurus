...
| **Paper release candidate** | Accepted survey + results + reviewed structured manuscript → claim index, bibliography, LaTeX, rendered PDF, release manifest | Implemented; real deterministic PDF path verified |
...
2. [Concept SSOT](docs/00-SSOT.md) — governing decisions D1–D44, authority, terminology
